...
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Legra', 'D''Aguanno', 'ldaguanno0@issuu.com', '15313 Burrows Alley', 'Hongzhou', 'China', '331-356-5166', 2.5, '08:19', '19:06', 4);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Lisle', 'Creeber', 'lcreeber1@google.de', '1955 Fair Oaks Plaza', 'Wushi', 'China', '518-718-7196', 1.4, '07:48', '19:03', 2);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Cybill', 'Exroll', 'cexroll2@barnesandnoble.com', '6 Paget Crossing', 'Xiejiatan', 'China', '879-718-3715', 4.6, '07:27', '13:08', 13);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Leticia', 'Gorch', 'lgorch3@cnn.com', '7 Cambridge Lane', 'Ternovka', 'Russia', '340-956-7178', 1.8, '09:42', '23:45', 17);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Ursula', 'Lago', 'ulago4@vimeo.com', '70075 Dwight Center', 'Rabat', 'Morocco', '110-752-9868', 3.6, '06:14', '21:30', 12);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Estella', 'O''Fairy', 'eofairy5@mac.com', '7585 East Avenue', 'Cempa', 'Indonesia', '826-319-0058', 1.8, '09:53', '22:36', 2);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Gus', 'Saunders', 'gsaunders6@deliciousdays.com', '49 Spaight Place', 'Birendranagar', 'Nepal', '663-229-0652', 3.0, '04:11', '19:28', 6);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Vic', 'Manzell', 'vmanzell7@google.pl', '603 Twin Pines Terrace', 'Talovyy', 'Russia', '750-404-3515', 3.0, '05:59', '22:24', 15);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Vidovik', 'Tinniswood', 'vtinniswood8@youtube.com', '36370 Clemons Plaza', 'Ōmura', 'Japan', '573-586-4455', 5.0, '05:37', '23:05', 5);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Maryjo', 'Attoc', 'mattoc9@cmu.edu', '0 Service Park', 'Libao', 'China', '514-451-5802', 2.5, '08:41', '23:35', 6);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Drusilla', 'Louden', 'dloudena@answers.com', '7 Reinke Alley', 'Kulotino', 'Russia', '806-674-8587', 2.4, '06:55', '22:41', 9);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Ingemar', 'Benediktovich', 'ibenediktovichb@pagesperso-orange.fr', '268 Ruskin Trail', 'Duisburg', 'Germany', '767-223-5108', 4.6, '16:20', '20:00', 15);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Heinrick', 'Cisneros', 'hcisnerosc@foxnews.com', '55295 Quincy Junction', 'Goczałkowice Zdrój', 'Poland', '554-379-6078', 2.7, '09:36', '21:58', 7);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Averil', 'Schust', 'aschustd@wiley.com', '323 Northwestern Parkway', 'Magisterial', 'Mexico', '466-894-0318', 1.1, '09:54', '23:24', 12);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Cam', 'Mack', 'cmacke@blogtalkradio.com', '30 Meadow Valley Pass', 'Huashan', 'China', '899-635-9624', 1.6, '05:42', '19:21', 14);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Bertrand', 'McKee', 'bmckeef@timesonline.co.uk', '6994 Eggendart Road', 'Lirang', 'China', '489-219-3319', 2.6, '06:24', '11:13', 3);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Filip', 'Aveyard', 'faveyardh@pcworld.com', '31845 Sommers Alley', 'Inderka', 'Russia', '508-426-2276', 1.4, '07:50', '21:47', 14);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Towney', 'Revill', 'trevilli@wunderground.com', '023 Dennis Parkway', 'Novokizhinginsk', 'Russia', '256-222-9432', 5.0, '06:49', '21:08', 12);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Leonhard', 'Eves', 'levesj@gizmodo.com', '3711 Mallard Place', 'Loudun', 'France', '815-313-2104', 4.4, '05:49', '23:57', 12);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Eugenia', 'Dewfall', 'edewfallk@ovh.net', '04205 Dennis Center', 'Ban Talat Bueng', 'Thailand', '636-258-1551', 1.2, '04:45', '22:37', 16);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Jacob', 'Fernyhough', 'jfernyhoughl@alibaba.com', '75 Dottie Court', 'Pombal', 'Portugal', '662-331-0762', 2.6, '07:27', '10:46', 1);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Mariya', 'Coggeshall', 'mcoggeshallm@ycombinator.com', '0 Shopko Way', 'Kletek', 'Indonesia', '414-707-3307', 1.5, '05:09', '22:15', 7);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Cordy', 'Duignan', 'cduignann@princeton.edu', '62889 Menomonie Crossing', 'Debrecen', 'Hungary', '539-346-4967', 1.1, '04:56', '23:34', 20);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Gertrudis', 'Bristowe', 'gbristoweo@163.com', '087 Becker Avenue', 'Srinagarindra', 'Thailand', '219-615-9281', 2.7, '04:06', '21:35', 7);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Adaline', 'Bines', 'abinesp@netlog.com', '6 Mesta Drive', 'Merapit', 'Indonesia', '254-777-1676', 2.0, '08:42', '23:47', 14);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Clemmy', 'Ebbs', 'cebbsq@artisteer.com', '90759 Crescent Oaks Trail', 'Banjar Sandinggianyar', 'Indonesia', '364-977-1445', 3.2, '06:02', '20:07', 6);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Dawn', 'Pickford', 'dpickfordr@theglobeandmail.com', '33 Corscot Place', 'Kongkeshu', 'China', '296-314-7258', 1.3, '04:40', '22:21', 2);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Denna', 'Scirman', 'dscirmans@myspace.com', '46897 Stuart Park', 'Koronowo', 'Poland', '330-928-5108', 3.3, '07:39', '20:18', 15);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Elbertina', 'Maghull', 'emaghullt@51.la', '1 Dennis Road', 'Dahua', 'China', '179-461-9623', 2.6, '07:46', '19:39', 6);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Gillian', 'Oolahan', 'goolahanu@home.pl', '75142 Waubesa Center', 'Barrinha', 'Brazil', '801-717-3748', 3.9, '05:32', '22:23', 19);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Charmain', 'Blaszczyk', 'cblaszczykv@blogspot.com', '84782 Michigan Hill', 'Xiangfeng', 'China', '952-534-1540', 4.3, '07:18', '19:43', 11);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Jonas', 'Holleworth', 'jholleworthw@photobucket.com', '49499 Hudson Place', 'Mahikeng', 'South Africa', '402-635-9321', 2.5, '05:28', '19:26', 15);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Shelden', 'Bairnsfather', 'sbairnsfatherx@mtv.com', '6551 Armistice Plaza', 'Shreveport', 'United States', '318-430-5716', 2.2, '05:30', '21:16', 5);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Berta', 'Golbourn', 'bgolbourny@hc360.com', '26294 Eastwood Center', 'Sagae', 'Japan', '849-660-4781', 1.9, '04:16', '19:45', 4);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Mariette', 'Bater', 'mbaterz@dell.com', '797 Emmet Crossing', 'Dhali', 'Cyprus', '364-644-6729', 2.5, '06:47', '21:12', 6);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Charlton', 'Huxster', 'chuxster10@prnewswire.com', '980 Pearson Street', 'Charikar', 'Afghanistan', '593-577-4916', 4.0, '05:28', '19:40', 5);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Enrika', 'Preist', 'epreist11@vkontakte.ru', '2638 Merry Terrace', 'Yasenevo', 'Russia', '775-950-4486', 2.8, '11:11', '17:00', 1);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Haydon', 'Shevlan', 'hshevlan12@chron.com', '580 Crowley Circle', 'Ryazanskaya', 'Russia', '820-142-4314', 3.4, '17:40', '22:13', 1);
insert into pharmacist (name, surname, email, adress, city, state, phone_num, stars, works_from, works_to, farmacy_id) values ('Sallie', 'Mandrey', 'jovana.jelisavcic95@gmail.com', '70347 Waywood Way', 'Dayrūţ', 'Egypt', '663-220-0307', 4.8, '22:24', '22:39', 1);
...
insert into dermatologist (name, surname, email, adress, city, state, phone_num, stars) values ('Cassandra', 'Timmermann', 'ctimmermann4@chron.com', '291 Bartelt Place', 'Oulmes', 'Morocco', '427-813-1145',3.9);
insert into dermatologist (name, surname, email, adress, city, state, phone_num, stars) values ('Shalom', 'Barneville', 'sbarneville5@nytimes.com', '968 Meadow Ridge Circle', 'Yosowilangun', 'Indonesia', '913-572-2827',4.1);
insert into dermatologist (name, surname, email, adress, city, state, phone_num, stars) values ('Brooke', 'Buckingham', 'bbuckingham6@macromedia.com', '1 Monterey Plaza', 'Laka', 'Indonesia', '716-189-6997',4.5);
insert into dermatologist (name, surname, email, adress, city, state, phone_num, stars) values ('Tanney', 'Lipscomb', 'tlipscomb7@acquirethisname.com', '6542 Montana Way', 'Datuan', 'China', '373-963-5079',4.7);
...
insert into COUNSELING (COUNSELING_ID,CANCELED,DATE_TIME,END_TIME,PRICE,EMAIL) values(2, false, '2021-08-28T12:00:00', '2021-08-28T12:20:00',11.52, 'cexroll2@barnesandnoble.com' );
